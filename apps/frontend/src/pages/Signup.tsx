        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
            <div className="w-full max-w-lg">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-3">Join Us Today</h1>
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 p-10">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-600">
                            ...
                            <span className="text-black font-bold "><Link to="/signin"><button className='cursor-pointer hover:underline'>Sign In</button></Link></span>
                        </p>
                    </div>
                </div>
            </div>
